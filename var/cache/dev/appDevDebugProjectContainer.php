...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ma_lrm_bundle.service.listener' => 'getMaLrmBundle_Service_ListenerService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('p31v0NlNC8', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bKIyeIUyKF', 0, 'HvGt5VMC-ej20D79uXD4FV', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ligne_rh', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MA\\LrmBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\MA\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MA\\LrmBundle\\Entity');
        $c->addDriver($b, 'MA\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MALrmBundle' => 'MA\\LrmBundle\\Entity', 'MAUserBundle' => 'MA\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_46531808713a41ace41ff769eecae576254a0b309f64bb8da7dc356779f157ce');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MA\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => 'email/email.txt.twig', 'from_email' => array('confirmation' => array('mohamedabdelmoumen@gmail.com' => 'Admin'), 'resetting' => array('mohamedabdelmoumen@gmail.com' => 'Admin'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MA\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MA\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MA\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'MA\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'ma_lrm_bundle.service.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MA\LrmBundle\Listener\LoadDataListener A MA\LrmBundle\Listener\LoadDataListener instance
     */
    protected function getMaLrmBundle_Service_ListenerService()
    {
        return $this->services['ma_lrm_bundle.service.listener'] = new \MA\LrmBundle\Listener\LoadDataListener(array('name' => 'kernel.event_listener'), array('event' => 'fullcalendar.set_data'), array('method' => 'loadData'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $s->setOptions(array('default_target_path' => '/admin/accueil', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('mohamedabdelmoumen@gmail.com');
        $a->setPassword('loul@1005');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MA\\LrmBundle/Resources/views'), 'MALrm');
        $instance->addPath(($this->targetDirs[3].'\\src\\MA\\UserBundle/Resources/views'), 'MAUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\MA\\UserBundle/Resources/views'), 'FOSUser');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XVELvT0IgY', 0, 'HvGt5VMC-ej20D79uXD4FV', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'MALrmBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MA\\LrmBundle'),
                    'namespace' => 'MA\\LrmBundle',
                ),
                'MAUserBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\MA\\UserBundle'),
            ...
            case 'cv_directory': $value = ($this->targetDirs[3].'\\app/../web/uploads/cvtheque'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MALrmBundle' => 'MA\\LrmBundle\\MALrmBundle',
                'MAUserBundle' => 'MA\\UserBundle\\MAUserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'ligne_rh',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'mohamedabdelmoumen@gmail.com',
            'mailer_password' => 'loul@1005',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'mohamedabdelmoumen@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'loul@1005',
            ...
            'fos_user.resetting.email.template' => 'email/email.txt.twig',
            'fos_user.registration.confirmation.template' => '@FOSUser/Registration/email.txt.twig',
            'fos_user.storage' => 'orm',
            'fos_user.firewall_name' => 'main',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'MA\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'mohamedabdelmoumen@gmail.com' => 'Admin',
            ),
